...
javac %JAVAFX_ARGS% -sourcepath %PRAC_SRC% -cp %PRAC_BIN%;%PRAC_LIB% -d %PRAC_BIN% %PRAC_SRC%\csc2b\client\BUKAClient.java
IF /I "%ERRORLEVEL%" NEQ "0" (
...
java %JAVAFX_ARGS% -cp %PRAC_BIN%;%PRAC_LIB% csc2b.client.BUKAClient
IF /I "%ERRORLEVEL%" NEQ "0" (
