...
namespace RecipeSpace
{
    ...
    void CraftAxe(tWorld& stcWorld, int intLogs, int intSticks, int intAxes)
    {
        if(stcWorld.Sticks < 3 || stcWorld.Logs < 1)
        {
            stcWorld.Sticks - 0;
            stcWorld.Logs - 0;
            stcWorld.Axes + 0;
    ...
    void CraftFK(tWorld& stcWorld, int intFlint, int intSticks, int intFK)
    {
        if(stcWorld.Sticks < 2 || stcWorld.Flint < 1)
        {
            stcWorld.Sticks - 0;
            stcWorld.Logs - 0;
            stcWorld.FK + 0;
